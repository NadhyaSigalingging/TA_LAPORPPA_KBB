...
@php
    $config = match((string)$status) {
        ...
        '1'     => ['label' => 'Diverifikasi',        'bg' => '#cfe2ff', 'color' => '#084298', 'icon' => 'fa-check-circle'],
        '2'     => ['label' => 'Diproses',            'bg' => '#d1ecf1', 'color' => '#0c5460', 'icon' => 'fa-spinner'],
        '3'     => ['label' => 'Selesai',             'bg' => '#d1e7dd', 'color' => '#0f5132', 'icon' => 'fa-check-double'],
